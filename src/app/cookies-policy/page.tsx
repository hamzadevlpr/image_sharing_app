          ...
          <div className="bg-white rounded-xl shadow-cus p-8 lg:p-12">
            ...
            <div className="mb-8">
              <p className="text-lg text-gray-700 leading-relaxed">
                This Cookie Policy explains how PicShare uses cookies and
                similar tracking technologies on our file-sharing platform. We
                believe in transparency about how we collect and use data to
            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  improve functionality, and analyze how you use our service.
                </p>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Hotjar:</strong> User experience and heatmap
                    analysis
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700">
                  ...
                  <br />
                  <strong>Address:</strong> 123 Cookie Street, Data City, DC
                  12345
                </p>
              </section>
            </div>
