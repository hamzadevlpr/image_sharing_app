...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: `${process.env.NEXT_PUBLIC_VERCEL_URl}/status`,
        siteName: "PicShare",
        images: [
            {
                url: `${process.env.NEXT_PUBLIC_VERCEL_URl}/og-images/status.png`,
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        images: [ `${process.env.NEXT_PUBLIC_VERCEL_URl}/og-images/status.png`],
    },
};
