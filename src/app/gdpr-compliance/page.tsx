          ...
          <div className="bg-white rounded-xl shadow-cus p-8 lg:p-12">
            ...
            <div className="mb-8">
              <p className="text-lg text-gray-700 leading-relaxed">
                PicShare is committed to protecting your privacy rights under
                the General Data Protection Regulation (GDPR). This page
                explains your rights as an EU resident and how we ensure
            ...
            <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-blue-50 p-6 rounded-lg">
                    ...
                    <p className="text-gray-700">
                      We provide clear information about how we collect, use,
                  ...
                  <div className="bg-teal-50 p-6 rounded-lg">
                    ...
                    <p className="text-gray-700">
                      You can request access to all personal data we hold about
                      you at any time.
                    </p>
                  </div>
                  <div className="bg-indigo-50 p-6 rounded-lg">
                    ...
                    <p className="text-gray-700">
                      You can correct inaccurate or incomplete personal data in
                      your account.
                    </p>
                  </div>
                  ...
                  <div className="bg-green-50 p-6 rounded-lg">
                    ...
                    <p className="text-gray-700">
                      You can export your data in a structured, machine-readable
                      format.
                    </p>
                  </div>
              ...
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  When transferring your data outside the EU, we ensure adequate
                  protection through:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <section>
                ...
                <div className="bg-teal-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700 mb-4">
                    To exercise your GDPR rights or ask questions about data
                    protection:
                  </p>
                  <ul className="space-y-2 text-gray-700">
                    <li>
                      <strong>Email:</strong> gdpr@picshare.com
                    </li>
                    <li>
                      <strong>Data Protection Officer:</strong> dpo@picshare.com
                    </li>
                    <li>
                      <strong>Address:</strong> 123 GDPR Street, Privacy City,
                      PC 12345
                    </li>
                    <li>
                      <strong>Response Time:</strong> Within 30 days of your
                      request
                    </li>
                  </ul>
                </div>
              ...
              <section>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li>
                      <strong>File Content:</strong> Per your retention settings
                    </li>
                    <li>
                      <strong>Usage Logs:</strong> Maximum 2 years
                    </li>
                    <li>
                      <strong>Support Tickets:</strong> 3 years after resolution
                    </li>
                    <li>
                      <strong>Payment Records:</strong> 7 years (legal
                      requirement)
                    </li>
                  </ul>
                </div>
