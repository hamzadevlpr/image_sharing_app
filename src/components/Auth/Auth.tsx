                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        {...register("password")}
                        className={`pl-10 pr-10 h-12 bg-white/50 border-gray-200/50 rounded-xl focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all ${errors.email ? "border-red-500" : ""
                          }`}
                      />
                      <button
                        type="button"
