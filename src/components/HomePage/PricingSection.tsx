...
const PricingSection = () => {
  return (
    <section
      id="pricing"
      className="py-20 bg-gradient-to-br from-teal-50 to-coral-50"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Get unlimited uploads, albums, and sharing—completely free. No
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* Pro Plan */}
            <Card
              className="border-2 border-teal-500 shadow-xl bg-white relative animate-fade-in"
            ...
            >
              ...
              <CardContent className="p-8">
                ...
                <Button
                  variant="outline"
                  className="w-full border-2 border-teal-500 text-teal-600 hover:bg-teal-50 text-lg py-6"
                  disabled
                >
                  Notify Me
                </Button>
            ...
            {/* Team Plan */}
            <Card
              className="border-2 border-gray-200 shadow-lg bg-white animate-fade-in"
            ...
            >
              <CardContent className="p-8">
                ...
                <Button
                  variant="outline"
                  className="w-full border-2 border-gray-300 text-gray-600 hover:bg-gray-50 text-lg py-6"
                  disabled
                >
                  Coming Soon
                </Button>
